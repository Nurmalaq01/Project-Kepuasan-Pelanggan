...
<symbol id="facebook" viewBox="0 0 16 16">
  ...
  <div class="container-fluid">
    ...
    <div class="col-md-6 px-0">
      <h4 class="display-8 fst-italic fw-bold border-bottom">DETAIL PELANGGAN (Bus)</h4>
    </div>
  </div>
</br>
<h5 class="fw-bold">Identitas Pelanggan</h5>
      <div class="table-responsive">
        <table class="table table-striped mb-0">
          <thead style="background-color: #1C304E;" class="text-white">
            <tr>
              <th scope="col">E-mail</th>              
              <th scope="col">Instansi/Nama Pelanggan</th>
            </tr>
          </thead>
          <tbody>
            @foreach($Form_One as $id)
            <tr>
              <td>{{$id->email}}</td>
              <td>{{$id->nama}}</td>
            </tr>
      ...
      <h5 class="fw-bold">Kepentingan</h5>
      ...
      <div class="table-responsive" id="ptg">
        <table class="table table-striped mb-0">
          ...
          <tbody>
          @foreach($Form_Three as $fthr)
            <tr>
            <td>{{$fthr->nama}}</td>
              <td>{{$fthr->kecepatanOne}}</td>
              <td>{{$fthr->ketepatanTwo}}</td>
              <td>{{$fthr->responThree}}</td>
              <td>{{$fthr->layananFour}}</td>
              <td>{{$fthr->pegawaiFive}}</td>
              <td>{{$fthr->etikaSix}}</td>
            </tr>
            @endforeach
          </tbody>
      ...
      <h5 class="fw-bold">Semua Penilaian</h5>
      <div class="table-responsive">
        <table class="table table-striped mb-0">
          <thead style="background-color: #1C304E;" class="text-white">
            <tr>
              <th scope="col">Instansi/Nama Pelanggan</th>
              <th scope="col">Penilaian Keseluruhan</th>
              <th scope="col">Saran-saran Dari Pelanggan</th>
            </tr>
          </thead>
          <tbody>
          @foreach($Form_Four as $ff)
            <tr>
              <td>{{$ff->nama}}</td>
              <td>{{$ff->simpulan}}</td>
              <td>{{$ff->saran}}</td>
