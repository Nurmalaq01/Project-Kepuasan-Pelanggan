...
<img class="d-block mx-auto mb-4" src="{{ asset('img/New2.png') }}" width="100" height="70">
          <h1 class="display-11 fs-2 fw-bold text-white">TERIMA KASIH</h1>
...
<div class="card rounded-3">
    ...
    <div class="col-xs-6 mx-auto">
      <p class="lead mb-4 fs-6">Kami sangat menghargai waktu yang telah disediakan untuk menyampaikan pendapat berkenaan dengan kinerja dan pelayanan kami. 
        Pendapat yang telah disampaikan merupakan hal penting bagi kami sebagai bagaian dari tanggung jawab kami dalam menyediakan pelayanan yang lebih bermutu.</p>
        <p class="lead mb-4 fs-6 text-primary"><a href="/" class="text-reset">click here to submit another form</a></p>
          </div>
        </div>
        </div>
</div>
